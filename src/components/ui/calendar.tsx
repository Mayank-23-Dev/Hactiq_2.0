  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-1.5 relative items-center mb-2",
        caption_label: "text-sm font-semibold tracking-tight",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 border border-border/80 hover:bg-muted text-foreground opacity-70 hover:opacity-100 transition-opacity"
        ),
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal text-foreground hover:bg-muted hover:text-foreground aria-selected:opacity-100 transition-all rounded-md"
        ),
