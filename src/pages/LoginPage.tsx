      ...
      <div className="relative w-full max-w-md bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-8 shadow-2xl flex flex-col transition-all duration-300 hover:border-white/[0.15]">
        ...
        {isForgotMode ? (
          ...
          <div className="space-y-4">
            ...
            {resetSuccess && (
              <div className="p-3 bg-green-500/10 border border-green-500/20 text-green-200 text-xs rounded-lg text-center leading-relaxed">
                If an account exists with this email, a password reset link has been sent.
              </div>
            )}

            {resetError && (
              <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-200 text-xs rounded-lg text-center flex items-center gap-2 justify-center">
            ...
            <form onSubmit={handleResetSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isResetLoading}
                className="w-full mt-2 py-3 bg-white hover:bg-gray-200 disabled:bg-white/50 disabled:cursor-not-allowed text-black text-sm font-semibold rounded-lg flex items-center justify-center gap-2 transition-all duration-200 cursor-pointer animate-none"
              >
                {isResetLoading && <Loader2 className="w-4 h-4 animate-spin" />}
            ...
            <div className="text-center pt-2">
              <button
                ...
                className="text-xs text-white hover:underline font-semibold transition-colors cursor-pointer select-none"
              >
                Back to Login
              </button>
            </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <button
                    ...
                    className="text-xs text-gray-400 hover:text-white hover:underline transition-colors cursor-pointer select-none"
                  >
                    Forgot password?
                  </button>
                </div>
